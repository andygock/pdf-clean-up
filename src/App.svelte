...
<div id="drop" on:drop={handleDrop} on:dragover={(e) => e.preventDefault()}>
  <div>
    ...
    <p>
      ...
      attempts to automatically force the PDF client to print. This attempts to
      remove this behaviour by removing the offending JavaScript code.
    </p>
    <p>
      All modifications are performed inside the browser and no data is stored
      or transmitted elsewhere.
    </p>
    <p>Source code: <a href="https://github.com/andygock/pdf-clean-up">GitHub</a></p>
  </div>
</div>
